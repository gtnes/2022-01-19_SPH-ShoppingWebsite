  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" @click="open">立即支付</a>        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
          </div>
...
export default {
  ...
  methods: {
    async getPayInfo() {
      let result = await this.$API.reqGetOrderInfo(this.orderId);
      if (result.code == 200) {
        this.payInfo = result.data
      }
    },

    // Element UI弹窗（使用 HTML 片段）
    async open() {
        // 生成二维码
