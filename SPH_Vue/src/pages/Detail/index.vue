            ...
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  :key="index"
                  @click="changeActivw(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)"
                >
...
export default {
  ...
  computed: {
    ...mapGetters(["categoryView", "skuInfo", "spuSaleAttrList", "price"]),
  ...
  methods: {
    changeActivw(spuSaleAttrValue, spuSaleAttrValueList){
      // 遍历所有属性isChecked属性设置为0
    ...
    async addShopcar(){
      try {
        ...
        // 将商品信息数据存储到会话存储中（会话存储只能存储字符串 JSON.stringify）
