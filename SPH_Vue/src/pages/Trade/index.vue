<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for='(address, index) in addressInfo' :key='address.id' @click="changeDefault(address, addressInfo)">
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b><i>{{(orderInfo.detailArrayList).length}}</i>件商品，总商品金额</b>
